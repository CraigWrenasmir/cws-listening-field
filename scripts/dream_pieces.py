...
from dream_pieces_193_216 import PIECES as CONTINUATION_193_216
DREAM_PIECES.extend(CONTINUATION_193_216)

from dream_pieces_217_240 import PIECES as CONTINUATION_217_240
DREAM_PIECES.extend(CONTINUATION_217_240)

from dream_pieces_241_264 import PIECES as CONTINUATION_241_264
DREAM_PIECES.extend(CONTINUATION_241_264)

from returning_waters import PIECES as RETURNING_WATERS
DREAM_PIECES.extend(RETURNING_WATERS)

from vernal_dances import PIECES as VERNAL_DANCES
DREAM_PIECES.extend(VERNAL_DANCES)

from imaginary_ensembles import PIECES as IMAGINARY_ENSEMBLES
DREAM_PIECES.extend(IMAGINARY_ENSEMBLES)

from singing_returns import PIECES as SINGING_RETURNS
DREAM_PIECES.extend(SINGING_RETURNS)
...
from further_light import PIECES as FURTHER_LIGHT
DREAM_PIECES.extend(FURTHER_LIGHT)
